          ...
          <div className='text-center lg:text-left mt-10 xl:mt-20 drop-shadow-[2px_1px_1px_rgba(0,0,0,0.9)]'>
            ...
            <div className='mx-auto max-w-4xl sm:text-start py-8'>
              ...
              <p className='m-5 text-lg leading-8 text-gray-400'>
                <ul
                  role='list'
                  className='mt-8 grid grid-cols-3 gap-3 text-sm leading-6 text-gray-600 sm:grid-cols-8 sm:gap-6'
                >
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoHtml5 className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoCss3 className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoJavascript className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoReact className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoBootstrap className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoTailwindCss className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoSpringBoot className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoJava className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <svg className='h-20 w-auto flex-none p-2 mr-4 rounded-md tex-sky-500 border border-sky-500' fill='#0ea5e9' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width='100' height='100' viewBox='0 0 50 50'>
                  ...
                  <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                      <BiLogoPostgresql className='h-20 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                    </a>
                  </li>
                </ul>
              </p>
