...
const Services = () => {
  return (
    <>
      <div className='bg-gradient-to-tl from-blue-900 via-slate-700 to-indigo-900 w-full h-lg min-h-[75vh] lg:min-h-[68vh] z-10' id='services'>
        <div className='flex-1 text-center lg:text-left drop-shadow-[2px_1px_1px_rgba(0,0,0,0.9)] pb-5'>
          <h1 className='lg:text-center text-[50px] font-semibold lg:text-[60px] text-slate-300 mb-12 drop-shadow-[5px_2px_1px_rgba(0,0,0,0.9)]'>Mis Servicios
          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <dl className='grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3'>
              ...
              <div className='mx-auto flex w-full  max-w-xs flex-col gap-y-4 border border-slate-400 p-8 rounded-md items-center'>
                <div className='h-px w-full m-4 bg-gradient-to-r from-transparent via-red-400 to-transparent' />
                <dt className='text-lg leading-7 text-gray-300 drop-shadow-[1px_1px_1px_rgba(0,0,0,0.9)]'>
                  Paginas Web Estáticas
                  <p className='text-sm leading-5 text-gray-400 mt-4'>
