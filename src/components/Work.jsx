import { BiLogoBootstrap, BiLogoCss3, BiLogoHtml5, BiLogoJava, BiLogoJavascript, BiLogoReact, BiLogoSpringBoot } from 'react-icons/bi'
          ...
          <div className='mx-auto mt-16 max-w-2xl rounded-lg ring-1 ring-gray-500 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none'>
            ...
            <div className='p-8 sm:p-8 lg:flex-auto'>
              ...
              >
                ...
                <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                  <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <BiLogoSpringBoot className='h-16 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                  </a>
                </li>
                <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                  <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <BiLogoJava className='h-16 w-auto flex-none text-sky-500 p-1 mr-4 rounded-md border border-sky-500' />
                  </a>
                </li>
                <li className='flex gap-x-3 drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                  <a className='drop-shadow-[2px_2px_2px_rgba(0,0,0,0.9)]'>
                    <svg className='h-16 w-auto flex-none p-2 mr-4 rounded-md border border-sky-500' fill='#0ea5e9' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width='100' height='100' viewBox='0 0 50 50'>
